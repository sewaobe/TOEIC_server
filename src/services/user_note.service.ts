...
export const createNoteService = async (note_data: Partial<IUserNote>, user_id: string) => {
...
export const updateNoteService = async (user_id: string, note_id: string, note_data: Partial<IUserNote>) => {
